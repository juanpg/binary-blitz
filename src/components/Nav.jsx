        ...
        <nav className="navbar bg-body-tertiary">
            ...
            <div className="container">
                ...
                <div className="d-flex gap-1">
                    ...
                    <button type="button" className="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#statsDialog" title="Your Stats" aria-label="Your Stats">
                    ...
                    <button type="button" className="btn btn-secondary" title="Global Leaderboard" aria-label="Global Leaderboard" disabled>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-globe" viewBox="0 0 16 16" aria-hidden="true">
                    ...
                    <button type="button" className="btn btn-secondary d-md-inline-block d-none" data-bs-toggle="modal" data-bs-target="#settingsDialog" title="Keyboard mapping" aria-label="Keyboard mapping">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16" aria-hidden="true">
